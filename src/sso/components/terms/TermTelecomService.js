...
export default class TermTelecomService extends Component{
  render(){
    return(
      <div>
        <div className="layer-pop_header">
          <h4 className="tit-h4">통신과금서비스 이용약관</h4>
        </div>
        <div className="pcon">
        <pre>{`제1조 (목적)
...
- 보호책임자 : 나이스페이먼츠(주) PG사업본부 본부장 장광현
- 전화번호 : 1661-0808
- 보호담당자 : 나이스페이먼츠(주) 경영지원본부 정동민
- 전화번호 : 1661-7335
